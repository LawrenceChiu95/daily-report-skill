...
| 飞书 IM | 你在群里发的消息；完整模式可选择私聊 | 是（setup 会检查 `search:message`、群聊/私聊读取 scope） |
| AI 对话记录 | Cursor / Codex / Claude Code / OpenClaw 当天的对话主题 | 否（读本地文件） |
...
- `FEISHU_BASE_URL` — 飞书租户域名，用于拼接会议纪要和知识库链接
